                                                                    ...
                                                                    <ul v-if="(list6.parentnode === key5)" class="left-nav-device-container">
                                                                      ...
                                                                      <li v-if="(list6.name)"><span id="L5123" data-level="L6" data-type='group' v-bind:data-display="list6.display_name" v-bind:data-parent="list6.parentnode" v-bind:data-groupkey="key6"><span class="fa fa-caret-down groupInspan" @click="deviceClick(key6, list6.parentnode, 6)">{{list6.name}}</span></span>
                                                                        <ul v-bind:id="key6" v-bind:class="{'collapse left-nav-device-container': collaps, 'collapse in left-nav-device-container submenu-3': !collaps}">
                                                                          <li>
                                                                            <draggable @end="Listdragleave('L6', list6.parentnode, list6.Device, 'device', key6)" @start="DragStart('L6', list6.parentnode, list6.Device, 'device', key6, ...arguments)"><span v-for="(device6, devicekey6) in leftsidedata.Device[key6]" v-bind:key="devicekey6" v-bind:data-key="devicekey6" data-level="L6" data-type='device' v-bind:data-groupkey="key6" v-bind:data-devicekey="device6.name" v-bind:data-parent="list6.parentnode"  v-bind:title="device6.name" v-bind:data-deviceid="device6.device_id" v-tippy="{ placement : 'bottom',  theme: 'tool1', duration: 500, arrow: true, size: 'large' }"><i class="fa fa-angle-double-right"></i>{{device6.name | trimDeviceName}}</span></draggable>
                                                                          </li>
                                                                        </ul>
                                                                      </li>
                                                                      </draggable>
