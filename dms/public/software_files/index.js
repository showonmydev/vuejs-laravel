    ...
    SyncData: (state, obj) => {
      ...
      //$.each(store.state, function (index, value) {
          //if(index == "L1" || index == "L2" || index == "L3" || index == "L4" || index == "L5" || index == "L6"){
            ...
            // $.each(store.state.L1, function (index1, value1) {
            //   // For Group
            //     console.log(value1);
            //    // children.name = value1
            //   $.each(store.state.L2, function (index2, value2) {
            //     // For Device
            //     $.each(store.device, function(DevIndex2, DevValue2){
