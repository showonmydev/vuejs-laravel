...
(function ($) {
  $.widget("akottr.dragtable", {
     ...
     * |   id2  |   id1   |   id3   |
     */
    _restoreState: function _restoreState(persistObj) {
    ...
    _bubbleCols: function _bubbleCols() {
      var i, j, col1, col2;
    ...
    _rearrangeTableBackroundProcessing: function _rearrangeTableBackroundProcessing() {
      var _this = this;
      return function () {
        _this._bubbleCols();
    ...
    _rearrangeTable: function _rearrangeTable() {
      var _this = this;
      return function () {
     ...
     */
    _generateSortable: function _generateSortable(e) {
