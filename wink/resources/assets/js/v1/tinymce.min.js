...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        var C, x, w, N, E, _, S, k, T, R, A, B, D, M, L, P, H, O, I, F = "sizzle" + -new Date, z = window.document, W = 0, V = 0, U = n(), $ = n(), q = n(), j = function (e, t) {
            return e === t && (A = !0), 0
        ...
        function i(i, a) {
            ...
            i = i || {}, l.schema = a = a || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), o("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var l = this, c, u = 0, d, f, h = [], p, m, g, v, y, b, C, x, w, N, E, _, S, k, T, R, A, B, D, M, L, P, H, O, I, F = 0, z = t.decode, W, V = n.makeMap("src,href,data,background,formaction,poster"), U = /((java|vb)script|mhtml):/i, $ = /^data:/i;
        ...
        return function (i, a) {
            ...
            var N = a.dom, E = t.each, _, S, k, T, R, A, B, D, M, L, P, H, O, I, F, z, W = a.getDoc(), V = document, U = r.ie && r.ie < 11, $ = Math.abs, q = Math.round, j = a.getBody(), Y, X;
        ...
        return function (c) {
            ...
            c.on("PreInit", function () {
                ...
                "mceResetDesignMode,mceBeginUndoLevel": function () {
                    ...
                    var m = L.getParent(h, L.isBlock), y = m ? m.nodeName.toUpperCase() : "", b = m ? L.getParent(m.parentNode, L.isBlock) : null, C = b ? b.nodeName.toUpperCase() : "", x = i && i.ctrlKey;
                ...
                "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull": function (e) {
                    var t = "align" + e.substring(7), n = P.isCollapsed() ? [L.getParent(P.getNode(), L.isBlock)] : P.getSelectedBlocks(), r = f(n, function (e) {
        ...
        return function (u) {
            ...
            var K = s.each, G = u.$, J = e.BACKSPACE, Q = e.DELETE, Z = u.dom, ee = u.selection, te = u.settings, ne = u.parser, re = u.serializer, ie = a.gecko, oe = a.ie, ae = a.webkit, se = "data:text/mce-internal,", le = oe ? "Text" : "URL";
        ...
        function y(c) {
            ...
            function Y() {
                ...
                var f = b(I, 1, te, E), g = b(I, -1, ne, N), v = b(j, 1, E), w = b(j, -1, N), _ = b(F, -1, a.upUntil), T = b(F, 1, a.downUntil);
            ...
            var Z = c.getBody(), ee = new t(Z), te = b(v, ee.next), ne = b(v, ee.prev), re = new o(c.getBody(), y), ie = "sel-" + c.dom.uniqueId(), oe, ae = c.$;
        ...
        var B = e.DOM, D = r.ThemeManager, M = r.PluginManager, L = N.extend, P = N.each, H = N.explode, O = N.inArray, I = N.trim, F = N.resolve, z = g.Event, W = w.gecko, V = w.ie;
        return A.prototype = {
            render: function () {
                function e() {
        ...
        return e.extend({
            recalc: function (e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v = [], y, b, C, x, w, N, E, _, S, k, T, R, A, B, D, M, L, P, H, O, I, F, z = Math.max, W = Math.min;
...
!function (a, b) {
    ...
    d("tinymce/spellcheckerplugin/DomTextMatcher", [], function () {
        ...
        b.add("spellchecker", function (b, i) {
            ...
            function o(a, d, e, j) {
                var k = {method: a, lang: F.spellchecker_language}, l = "";
                k["addToDictionary" == a ? "word" : "text"] = d, c.each(k, function (a, b) {
